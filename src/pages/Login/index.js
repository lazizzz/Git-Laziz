...
function LoginRoute() {
         ...
         const {emailInp , setEmailInp} = useState("");
          ...
          const search = ()=>{
            ...
            // navigate("/")
            alert("zor")
            localStorage.removeItem("email","emailInp")
          }else{
            alert("Pashol Naxuy")
          }
          }
        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-lg mx-auto">
            ...
            <form>
              ...
              <button onClick={search} className="inline-block w-full py-4 px-6 mb-6 text-center text-lg leading-6 text-white font-extrabold bg-indigo-800 hover:bg-indigo-900 border-3 border-indigo-900 shadow rounded transition duration-200">
                Sign in
              </button>
